...
🎯 Target: {target_uid}
🤖 Bot Name: —͞Hᴀsɪʙ Cᴏᴅᴇxᅠ
✅ Status: Ready to join

📱 Player will see:
"—͞Hᴀsɪʙ Cᴏᴅᴇxᅠ wants to join your team"
...
async def request_join_with_badge(target_uid, badge_value, key, iv, region):
    ...
    fields = {
        ...
        2: {
            ...
            6: "iG:[C][B][FF0000] —͞@Hᴀsɪʙ Cᴏᴅᴇxᅠ",
            7: 330,
            8: 1000,
            10: region.upper(),
...
[FFDD00]━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[00FF00][b][c]BOT MADE BY Hᴀsɪʙ Cᴏᴅᴇx GMR  
"""
        else:
...
[FFDD00]°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[00FF00][b][c]BOT MADE BY HASIB CODEX
"""
        else:
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][DA70D6]❀️POWER BY [FFFFFF] </> Hᴀsɪʙ Cᴏᴅᴇx
"""
...
[C][B][FFFF00]│[FF0000]▶[00FFFF]│[00FFFF]║[FFFFFF] HASIB CODEX TCP BOT[FFFF00]║
...
#GALI SPAM MESSAGE 
                        ...
                        BLOCKED_NAMES = ["hasib", "hasid", "Hasib 6t9", "HASIB"]  # Add your actual name
                            ...
                            try:
                                ...
                                if len(parts) < 2:
                                    ...
                                    messages = [
                                        ...
                                        "[B][C]{Name} amr [FF00FF] abba hasib",
                                        "[B][C]{Name} [00FF00] ami hasib ar chele ",
...
# FIXED HELP MENU SYSTEM - Now detects commands properly
                        ...
                        if inPuTMsG.strip().lower() in ("hasib", "/help", "hi", "x", "1"):
...
[B][FF1493]──────────────────
[B][FFD700]FUN & Tools
[B][FF1493]├─[00FF00]/luck [FFFFFF](ভাগ্যপরীক্ষা)
...
[B][4169E1]├─[FFFFFF]Owner: [FFD700] Hᴀsɪʙ 6T9
[B][4169E1]└─[FFFFFF]TG: @hasib_hi 
[B][4169E1]──────────────────
[B][FF0000]WARNING
...
async def MaiiiinE():
    ...
    if not credentials:
        ...
        print("📝 Format: uid=4536460656,password=700444E2B1956E9E34FA9A823F974874AA13BCBBDFD199872D9334F327F5EB32")
        return None
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 HASIB CODEXᅠ BOT - INITIALIZING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 HASIB CODEXᅠ BOT - STARTING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 HASIB CODEXᅠ BOT - CONNECTING")
    print("=" * 50)
    print("┌────────────────────────────────────┐")
    print("│ ██████████████████████████████████ │")
    print("└────────────────────────────────────┘")
